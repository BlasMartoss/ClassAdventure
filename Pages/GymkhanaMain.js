      ...
      <View style={styles.container}>
        ...
        <View style={styles.infoView}>
          ...
          <Text style={styles.subTitle}>
            These are the main characteristics of the gymkhana
          </Text>
        </View>
        ...
        <View style={styles.buttonsView}>
          <TouchableOpacity
            ...
            style={[styles.button1, { backgroundColor: individualColor }]}
          >
            <Text
              style={[
                styles.buttonTextIndividual,
          ...
          <TouchableOpacity
            ...
            style={[styles.button2, { backgroundColor: groupColor }]}
          >
            <Text style={[styles.buttonTextGroup, { color: groupTextColor }]}>
              Groups
            </Text>
          </TouchableOpacity>
        </View>
        ...
        {group && (
          <View style={styles.container3}>
            {/* Decrement button */}
            <TouchableOpacity
              onPress={decrementPlayersPerGroup}
            ...
            {/* Increment button */}
            <TouchableOpacity
              onPress={incrementPlayersPerGroup}
              style={styles.button_2}
            >
              <Text style={styles.buttonText2}>+</Text>
            </TouchableOpacity>
