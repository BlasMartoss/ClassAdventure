...
export default function Home({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.email}>emailexample@example.com</Text>
      </View>
      ...
      <View style={styles.emailView2}>
      <Text style={styles.email}>Organizer</Text>
      </View>
      <View style={styles.line}></View>
      <Image
            ...
            />
             ...
             <Text style={styles.messageText}>Here you can see your Gymkhanas</Text>
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('ViewGymkhanas')}>
