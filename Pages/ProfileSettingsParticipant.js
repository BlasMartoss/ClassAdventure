     ...
     <View style={styles.HeaderContainer}>
        <ImageBackground source={require('../images/BackgroundImage.png')} style={styles.backgroundImage} imageStyle={styles.imageBorderRadius}>
          <View style={styles.headerView}>
              ...
              <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('ProfileParticipant')}> 
                    <Image
        ...
        <TouchableOpacity style={styles.configurationView} onPress={() => navigation.navigate('EditProfileParticipant')}> 
            <Image
       ...
       <TouchableOpacity style={styles.configurationView} onPress={() => navigation.navigate('')}> 
        ...
        <TouchableOpacity style={styles.configurationView} onPress={() => navigation.navigate('AppInformation')}> 
            <Image
